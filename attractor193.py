...
colormap = cmocean.cm.cmap_d.get("rain_r")

background = 'black'
coefs = [-0.41282409640861406,0.7779135067977982,2.1480149666764348,-0.01467035871472433]
...
image.save("attractor193.png","PNG")
buf.close()
image.close()
img.close()
print('DONE')
