...
colormap = mp.colormaps["cmr.swamp"]

background = 'black'
coefs = [-1.2195743113299264,2.021284406961784,-0.019345194984778935,0.25501089893566053]
...
cvs = ds.Canvas(plot_width = int(sizepx), plot_height = int(sizepx), x_range=(-2.1,2.1), y_range=(-2.1,2.1))
...
image.save("attractor203.png","PNG")
buf.close()
image.close()
img.close()
print('DONE')
